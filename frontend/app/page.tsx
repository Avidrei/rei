...
export default function Home() {
  ...
  useEffect(() => {
    const syncHistoricalLogs = async () => {
      try {
        ...
        // 2. Fetch available active uploaded tracking datasets
  ...
  return (
    <main className="h-screen bg-[#070709] text-zinc-100 flex flex-col overflow-hidden relative selection:bg-emerald-500/30 selection:text-emerald-300 antialiased font-mono">
      <div className="absolute inset-0 bg-[radial-gradient(#1c1c24_1px,transparent_1px)] [background-size:16px_16px] opacity-10 pointer-events-none" />

      {/* Top Banner Header */}
      <header className="border-b border-zinc-800/60 px-6 py-3 flex items-center justify-between bg-[#0b0b0f]/80 backdrop-blur-xl z-50 flex-shrink-0 shadow-[0_1px_10px_rgba(0,0,0,0.8)] relative">
        ...
        {/* 🌟 UPGRADE: Context Stream Selector Block */}
        <div className="flex items-center space-x-2 bg-zinc-950/80 px-3 py-1 rounded-xl border border-zinc-900">
          ...
          {uploadedFiles.length === 0 ? (
            ...
            <select
              ...
              className="bg-zinc-900 border border-zinc-800 rounded px-2 py-0.5 text-[10px] font-bold text-emerald-400 focus:outline-none focus:border-emerald-500/50 cursor-pointer min-w-[140px]"
            >
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <div className="w-7/12 flex flex-col bg-[#08080c] relative">
          ...
          <form onSubmit={handleSendMessage} className="p-4 border-t border-zinc-900/80 bg-[#09090d]/90 backdrop-blur-md flex-shrink-0 relative space-y-3">
